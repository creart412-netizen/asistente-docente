...
if st.session_state.selected_section == "✏️ Revisión Ortográfica":
    ...
    def get_language_tool():
        try:
            # FIX: Pasar el argumento 'language' solo una vez
            # Usar el servidor de LanguageTool por defecto (no requiere Java local)
            return language_tool_python.LanguageTool(language='es-ES')
        except Exception as e:
