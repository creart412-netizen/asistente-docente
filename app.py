                ...
                if not openai.api_key:
                    ...
                    try:
                        ...
                        if st.session_state.ai_persona == "🎓 Asistente Pedagógico":
                            ...
                            system_role_prompt = f"Eres un guía escolar amigable y claro para estudiantes. Responde de forma sencilla, directa y didáctica, adaptando la explicación al nivel de un estudiante de {st.session_state.nivel_ode_chat}. Fomenta el aprendizaje y la curiosidad. Evita jergas complejas y respuestas robotizadas."
                        else: # "💬 Asistente General"
